...
def main(cfg):
    ...
    # 스페셜 토큰 추가하기
    special_tokens = {"additional_special_tokens": ["<sep>", "<NT>", "<NF>", "<market_entity>", "<market_target>", "<benefit_cond>", "<benefits>", "dis_figure", "prom_items", "prom_place", "event_period", "dow_info", "season_info", "soli_point"]}
